			  ...
			  <tr>
					...
					<table border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse" bordercolor="#111111" width="100%">    
					  <tr>
						...
						<td width="100%">&nbsp;<b>Update Record || User</b></td>
					  </tr>
					  <tr>
						<td width="100%">&nbsp;</td>
					  </tr>
						...
						<td width="100%">
							...
							?>
								...
								<tr>
									...
									<td align="left" width="25%">
										<input type="text" name="userLevel" id="userLevel"  size="15" disabled value="<?php echo $row['userLevel'];?>">
									</td>
								</tr>
								<tr>
									<td align="right" width="15%">Email : </td>
									<td align="left" width="25%">
										<input type="text" name="email" id="email"  required size="25" value="<?php echo $row['email'];?>">
									</td>
								</tr>
								<tr>
