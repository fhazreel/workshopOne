...
<body>
<div class="form">
<h2><center>View Admin Records</center></h2>
...
<table width="100%" bgcolor="#E6E6E6" border="1" bordercolor="#000000" cellpadding="5" cellspacing="0" style="font-family:Arial, Helvetica, sans-serif; font-size:14px">
	...
	<tbody>
			...
			$sel_query="Select id, userLevel, username, email from login WHERE userLevel = 'Admin';";
			...
			while($row = mysqli_fetch_assoc($result)) { ?>
				...
				<td align="center"><a href="edit_by_admin.php?id=<?php echo $row["id"]; ?>">Edit</a></td>
				<td align="center"><a href="delete_by_admin.php?id=<?php echo $row["id"]; ?>">Delete</a></td>
			</tr>
			<?php $count++; } ?>
			</tbody>
			</table>
...
<br /><br />
	<tr>
		<td style="float:right;" align="right" width="100%" >
			<input  type="button" name="insertBtn" value="Insert New Record" onClick="window.location.href='add_by_admin.php'" />
