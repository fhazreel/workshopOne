	...
	$db = mysqli_connect('localhost', 'root', '', 'eblood');
		...
		//check redundant data
			...
			if($checkrows > 0 ) { 
				...
				echo 'window.location.href="add_by_user.php";';
				echo'</script>';
			}  else {
				...
				window.location.href='view_by_user.php';
				</script>");
	}}}
			  ...
			  <tr>
					...
					<table border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse" bordercolor="#111111" width="100%">    
					  <tr>
						...
						<td width="100%">&nbsp;<b>Insert New Record || User Data</b></td>
					  </tr>
					  <tr>
						<td width="100%">&nbsp;</td>
					  </tr>
							...
							<table width="100%" style="font-family:Arial, Helvetica, sans-serif; font-size:14px">
								...
								<tr>
									...
									<td align="left" width="25%">
										<input type="text" name="username" required id="username"  size="25">
									</td>
									<td align="right" width="15%">User Level : </td>
									<td align="left" width="25%">
										<input type="hidden" name="userLevel" id="userLevel" value="Donor">
										<input style="text-transform: uppercase;" type="text" name="userLevel" id="userLevel" disabled value="Donor" size="25" >
									</td>
								</tr>
								<tr>
									<td align="right" width="15%">Email : </td>
									<td align="left" width="25%">
										<input type="text" name="email" required id="email"  size="25">
									</td>
								</tr>
								<tr>
									<td align="right" width="15%">Password : </td>
									<td align="left" width="25%">
										<input type="password" name="password" required id="password"  size="25">
									</td>
								</tr>
								</table>
									</td>
